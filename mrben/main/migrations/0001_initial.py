...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_entry_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entry', models.ForeignKey(orm['main.entry'], null=False)),
            ('category', models.ForeignKey(orm['main.category'], null=False))
        ))
        db.create_unique('main_entry_categories', ['entry_id', 'category_id'])

        # Adding model 'Link'
        db.create_table('main_link', (
    ...
    def backwards(self, orm):
        ...
        db.delete_table('main_entry_categories')
    ...
    models = {
        ...
        'main.entry': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.Category']", 'null': 'True', 'blank': 'True'}),
